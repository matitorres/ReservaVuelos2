...
public class VistaVueloAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonCerrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonCerrar.png"))); // NOI18N
        jButtonCerrar.setBorder(null);
        jButtonCerrar.setContentAreaFilled(false);
        jButtonCerrar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonCerrar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonCerrarSelec.png"))); // NOI18N
        jButtonCerrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButtonCerrarActionPerformed(evt);
            }
        });
        JPanel.add(jButtonCerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 30, 15, 15));
        ...
        jButtonFiltrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonFiltrar.png"))); // NOI18N
        ...
        jButtonFiltrar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonFiltrarSelec.png"))); // NOI18N
        JPanel.add(jButtonFiltrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 70, 75, 31));

        jScrollPaneVuelos.setBorder(null);
        ...
        jTableVuelos.setColumnSelectionAllowed(true);
        jTableVuelos.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jTableVuelos.getTableHeader().setReorderingAllowed(false);
        jScrollPaneVuelos.setViewportView(jTableVuelos);
        jTableVuelos.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        jButtonEliminar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonEliminar.png"))); // NOI18N
        jButtonEliminar.setBorder(null);
        jButtonEliminar.setBorderPainted(false);
        jButtonEliminar.setContentAreaFilled(false);
        jButtonEliminar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jButtonEliminar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonEliminarSelec.png"))); // NOI18N
        JPanel.add(jButtonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(237, 660, 159, 31));

        jButtonModificar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonModificar.png"))); // NOI18N
        ...
        jButtonModificar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonModificarSelec.png"))); // NOI18N
        JPanel.add(jButtonModificar, new org.netbeans.lib.awtextra.AbsoluteConstraints(403, 660, 159, 31));

        jButtonAgregar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonAgregar.png"))); // NOI18N
        ...
        jButtonAgregar.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/BotonAgregarSelec.png"))); // NOI18N
        JPanel.add(jButtonAgregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 660, 159, 31));

        jLabelTriangulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/reservadevuelos/imagenes/Triangulo.png"))); // NOI18N
        JPanel.add(jLabelTriangulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(31, 361, -1, -1));
